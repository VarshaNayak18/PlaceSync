...
function AdminDashboard() {
  ...
  const [interviewSuccess, setInterviewSuccess] =
    useState("");

  const [interviewFormError, setInterviewFormError] =
    useState("");
    ...
    async (event) => {
      ...
      try {
        ...
        const interviewData = {
          ...
          interviewDateTime:
            interviewForm.interviewDateTime,
            ...
            <div>
              ...
              >
                ...
                <StatCard
                  ...
                  value={
                    dashboard.totalScheduledInterviews
                  }
                />
